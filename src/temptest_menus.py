...
@patch("menus.print_db_table")
@patch("builtins.input")
@patch("builtins.print")
def test_products_menu_choice(mock_print:Mock, mock_input: Mock, mock_print_db_table:Mock):
    #assemble
    expected_print= '''
        1   See Products
        2   Amend Products
    ...
    #assert
    mock_print.assert_called_with(expected_print)
    mock_print_db_table.assert_called()
    mock_print_db_table.assert_called_with(dummy_product_list)
    assert mock_print_db_table.called
